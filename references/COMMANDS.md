...
| Parameter | Description |
|------|------|
| `--session-mode` | `auto` (default) / `lite` / `pro` / `ultra` |
...
File analysis uses `auto` mode by default.
...
|------|------|------|------|----------|
| `auto` | Backend intelligent decision based on query complexity | Varies | Varies | Default for all scenarios |
| `lite` | Quick SQL query + natural language response, supports follow-up questions | 30 sec - 2 min | ❌ | Simple queries, data validation |
| `pro` | Deep analysis, generates complete report | 5-15 min | ✅ | Topic analysis, business reports |
| `ultra` | Most thorough, multi-dimensional, in-depth data insights | 20-40 min | ✅ | Strategic analysis, trend research |

> **⚠️ Important**: When you need to generate reports (HTML/Markdown/charts), **pro or ultra mode is recommended**.
